...
/**
 * Shared route-group loading fallback. A tasteful, on-brand skeleton that echoes
 * the typical page layout (atmospheric glow + hero header + content cards) so
 * navigations feel instantaneous and never flash blank. Reused by each route
 * group's `loading.tsx` so a nested segment shows this scoped fallback (the
 * surrounding chrome stays mounted) instead of the global one. Purely
 * presentational and accessible (announced as busy).
 */
